...
/*   Updated: 2021/03/01 13:15:20 by lbertran         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
	view->settings->sprite_texture[SPRITE_HEALTH] = read_texture("./textures/.static/heart32.xpm", view);
	view->settings->sprite_texture[SPRITE_TRAP] = read_texture("./textures/.static/trap.xpm", view);
	view->settings->sprite_texture[SPRITE_SHROOM] = read_texture("./textures/.static/shroom.xpm", view);
	view->settings->cup_texture[0] = read_texture("./textures/.static/cup0.xpm", view);
	view->settings->cup_texture[1] = read_texture("./textures/.static/cup1.xpm", view);
	view->settings->cup_texture[2] = read_texture("./textures/.static/cup2.xpm", view);
	view->settings->heart_empty_texture = read_texture("./textures/.static/heart_empty.xpm", view);
	view->settings->win_screen = read_texture("./textures/.static/win.xpm", view);
	view->settings->hud_texture = read_texture("./textures/.static/hud.xpm", view);
}
